...
public class WaypointMover : MonoBehaviour
{
    ...
    void Travel()
    {
        ...
        {
            overX = true;
            float newX = Mathf.Lerp(transform.position.x, currentTarget.x, Time.deltaTime);
        ...
        {
            overY = true;
            float newY = Mathf.Lerp(transform.position.y, currentTarget.y, Time.deltaTime);
        ...
        {
            overZ = true;
            float newZ = Mathf.Lerp(transform.position.z, currentTarget.z, Time.deltaTime);
